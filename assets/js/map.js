...
const initialZoom = 5;
const initialCoordinates = [51, 10];
let map = new ol.Map({
...
var germanyBoundary = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/wms',
        params: { 'LAYERS': 'gis:COL_adm0', 'STYLES': 'restricted' }
    }),
});
map.addLayer(germanyBoundary);
...
var germanyDepartments = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        url: 'https://www.gis-geoserver.polimi.it/geoserver/wms',
...
map.addLayer(germanyDepartments);
